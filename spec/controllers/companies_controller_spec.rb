...
RSpec.describe CompaniesController, type: :controller do
  ...
  # before do
  #   @company = Company.create(name: 'Netflix', url: 'http://www.netflix.com', description: 'a'* 10)
  # end
  # let!(:company) { Company.create(name: 'Netflix', url: 'http://www.netflix.com', description: 'a'* 10) }
  ...
  describe "DELETE #destroy" do
    it "destroys the requested company" do
      expect {
        delete :destroy, {:id => company.id}, valid_session
      }.to change(Company, :count).by(-1)
    end
